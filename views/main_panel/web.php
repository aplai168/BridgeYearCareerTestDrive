<div class = "container" style = "padding-top: 40px;">
	...
	<div class = "row">
		...
		<div class = "col-md-6">
			...
			<div class = "row">
				<div class = "col-md-4">
					<button class = "btn btn-primary" id = "refreshCode">Update Code</button>
				</div>
				<div class = "col-md-4">
					<button class = "btn btn-primary" id = "resetCode">Reset Code</button>
				</div>
			</div>
		</div>
	</div>
...
<script type="text/javascript">
	...
	User.prototype.update = function(){
		alert(document.getElementById('formCode').value);
		this.code = document.getElementById('formCode').value;
		alert(this.code);
	}

	User.prototype.resetCode = function(){
		alert(this.code);
		document.getElementById('formCode').value = this.code;
